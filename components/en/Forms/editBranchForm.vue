      ...
      <form v-if="!loading" class="en-CategoryForm-content" @submit.prevent="addCategeroy">
        <div class="en-singleBranch-main-left-form">
          ...
          <v-select
            ...
            label="Merchant"
              outlined dense :rules="[(v) => !!v || 'Merchant is required']"
            required
            :items="merchants"
            item-value="_id"
            item-text="name"
          ...
          <v-text-field v-model="branch.name" :success="!!branch.name"
                          outlined dense :rules="[(v) => !!v || 'Branch Name is required',]" label="Branch Name" required/>
          <v-text-field v-model="branch.arName" :success="!!branch.arName"
            outlined dense :rules="[(v) => !!v || 'Arabic Branch Name is required',]" label="Arabic Branch Name" required/>
          <v-text-field
            v-model="branch.phone"
            :success="!!branch.phone"
              outlined dense :rules="[(v) => !!v || 'Phone Number is required',
          ...
          <v-text-field
            ...
            label="Email"
              outlined dense :rules="[(v) => !!v || 'E-mail is required',
          ...
          <v-text-field
            ...
            :success="!!branch.address"
              outlined dense :rules="[(v) => !!v || 'Address is required']"
            label="Address"
            required
          />
          <v-text-field
            v-model="branch.arAddress"
            :success="!!branch.address"
              outlined dense :rules="[(v) => !!v || 'Arabic Address is required']"
            label="Address"
            required
          />
          <div class="en-singleBranch-main-right">
            <!-- <v-text-field
              ...
              :success="placeIsCorrect"
                outlined dense :rules="[(v) => !!v || 'Place is required']"
          ...
          <div class="en-categoryForm-content-button">
            <div class="en-CategoryForm-content-button-TheButton">
              <v-btn color="success" @click="update()">Update Branch</v-btn>
            </div>
          </div>
        </div>
      </form>
      ...
      update() {
        ...
        let branchData = {
            branch: {
              ...
              arName: this.branch.arName,
              branchId: "1",
              address: this.branch.address,
              arAddress: this.branch.arAddress,
