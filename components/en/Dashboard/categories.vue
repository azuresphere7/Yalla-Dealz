...
export default {
  ...
  data () {
    return {
      headers: [
        { text: 'Icon', value: 'icon', align: 'start', class: 'text-h6', sortable: false},
        { text: 'Name', value: 'name', class: 'text-h6'},
        { text: 'Category', value: 'parent.name', class: 'text-h6'},
        { text: 'Description', value: 'description', class: 'text-h6', sortable: false},
        { text: 'Tags', value: 'tags', class: 'text-h6', sortable: false},
