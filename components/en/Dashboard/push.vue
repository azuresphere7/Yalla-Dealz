    ...
    <v-row justify="center" class="text-center" dense>
      <v-col cols="12" md="8">
        <v-card elevation="5" class="p-4 mt-10 mt-md-3">
          <v-card-title>Firebase Notifications</v-card-title>
          <v-container>
            <v-form @submit.prevent="submitForm()" ref="form" v-model="valid">
              <v-row justify="center" dense>
                ...
                <v-col cols="9" class="ml-5">
                  <v-text-field :rules="requiredRule" label="Title" v-model="messageForm.title" outlined dense></v-text-field>
                </v-col>
                <v-col cols="9" class="ml-5">
                ...
                <v-col cols="10">
                  <v-btn v-if="!image" color="success" class="rounded-xl" dark block>
